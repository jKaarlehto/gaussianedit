...
- PRODUCT means GaussianEdit 3D editor work only. Board, site, connector,
  orchestration/framework, audit, dispatch, agent, release-plumbing, and
  maintenance jobs are SYSTEM and never count toward product Done, Under way,
  Waiting, or Needs attention totals. Dispatch existing eligible SYSTEM
